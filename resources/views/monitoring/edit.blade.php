            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4> Edit Monitoring #{{ $monitoring->id }} </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/monitoring/monitoring/' . $monitoring->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            @include ('monitoring.form', ['formMode' => 'edit'])
